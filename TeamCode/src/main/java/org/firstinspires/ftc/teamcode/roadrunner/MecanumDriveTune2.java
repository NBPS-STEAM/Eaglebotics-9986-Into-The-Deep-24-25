 ...
 * <p>This is tuned for when the raise is lowered, and it drives at an aggressive speed.</p>
 * <p>Please see {@link MecanumDrive} for more information.</p>
 */
@Config
public final class MecanumDriveTune2 {
    public static class Params {
        ...
        public double minProfileAccel = -50.0;
    ...
    public class DriveLocalizer implements Localizer {
        ...
        public DriveLocalizer() {
            leftFront = new OverflowEncoder(new RawEncoder(MecanumDriveTune2.this.leftFront));
            leftBack = new OverflowEncoder(new RawEncoder(MecanumDriveTune2.this.leftBack));
            rightBack = new OverflowEncoder(new RawEncoder(MecanumDriveTune2.this.rightBack));
            rightFront = new OverflowEncoder(new RawEncoder(MecanumDriveTune2.this.rightFront));
    ...
    public MecanumDriveTune2(HardwareMap hardwareMap, Pose2d pose) {
        this.pose = pose;
