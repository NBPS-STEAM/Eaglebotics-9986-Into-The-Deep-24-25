 ...
 * <p>This is tuned for when the raise is lowered, and it drives at a conservative speed.</p>
 * <p>Please see {@link MecanumDrive} for more information.</p>
 */
@Config
public final class MecanumDriveTune1 {
    public static class Params {
        ...
        public double trackWidthTicks = 815.3968998030629;

        // feedforward parameters (in tick units)
        public double kS = 1.8468746092462425;
        public double kV = 0.003969697344562137;
        public double kA = 0.00005;

        // path profile parameters (in inches)
        public double maxWheelVel = 30.0;
        ...
        public double maxAngAccel = Math.PI * 0.9;
    ...
    public class DriveLocalizer implements Localizer {
        ...
        public DriveLocalizer() {
            leftFront = new OverflowEncoder(new RawEncoder(MecanumDriveTune1.this.leftFront));
            leftBack = new OverflowEncoder(new RawEncoder(MecanumDriveTune1.this.leftBack));
            rightBack = new OverflowEncoder(new RawEncoder(MecanumDriveTune1.this.rightBack));
            rightFront = new OverflowEncoder(new RawEncoder(MecanumDriveTune1.this.rightFront));
    ...
    public MecanumDriveTune1(HardwareMap hardwareMap, Pose2d pose) {
        this.pose = pose;
